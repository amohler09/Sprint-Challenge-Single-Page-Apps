...
> Answer: Client side routing can be very nice for user experience. Although there may be a few downfalls, client-side routing processes less data, so navigating to another page is generally going to be faster along with smoother transitions and animations. You won’t see a page refresh every time you go to another page, and you will have more control over your site URL and content without having to wait for a server to respond with content.
